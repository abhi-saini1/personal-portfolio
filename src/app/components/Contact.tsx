    ...
    <div className=' mx-auto'>
      ...
      <div className='flex flex-col items-center lg:flex-row lg:justify-between pt-10'>
        ...
        <div className='gs_reveal reveal_left flex justify-center mb-10 lg:mb-0'>
          <Image src='/contact.png' className='xl:w-[500px] xl:h-[500px] lg:w-[500px] lg:h-[500px] md:w-[450px] md:h-[450px] sm:w-[300px] sm:h-[300px] w-[300px] h-[300px]'  width={500} height={500} alt='contact' />
        </div>
        {/* form */}
